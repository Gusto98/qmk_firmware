...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        ...
        /*
        [_WORKMAN] = LAYOUT_ortho_5x15(KC_ESC, KC_Q, KC_D, KC_R, KC_W, KC_B, KC_NO, KC_NO, KC_NO, KC_J, KC_F, KC_U, KC_P, KC_SCLN, KC_BSLS, KC_LSFT, KC_A, KC_S, KC_H, KC_T, KC_G, KC_NO, KC_NO, KC_NO, KC_Y, KC_N, KC_E, KC_O, KC_I, RSFT_T(KC_QUOT), LCTL_T(KC_CAPS), KC_Z, KC_X, KC_M, KC_C, KC_V, KC_NO, KC_NO, KC_NO, KC_K, KC_L, KC_COMM, KC_DOT, KC_SLSH, RCTL_T(KC_DEL), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, LT(6,KC_LBRC), LGUI_T(KC_ENT), KC_NO, LT(10,KC_APP), LT(6,KC_RBRC), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_LGUI, KC_LALT, LT(7,KC_MINS), LT(5,KC_SPC), LT(8,KC_TAB), KC_NO, LT(8,KC_BSPC), LT(5,KC_ENT), LT(7,KC_EQL), KC_RALT, KC_RGUI, KC_NO, KC_NO),
        */
        [_QWERTY] = LAYOUT_ortho_5x15(
                ...
                KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_BSLS, KC_RSFT, KC_END, KC_UP, KC_PGDN,
                
                KC_LCTL, KC_LGUI, KC_LALT, 
                KC_NO, KC_NO, KC_SPC, KC_SPC, KC_NO, LT(_SWAP, KC_APP), 
                KC_RALT, KC_RGUI, KC_RCTL, KC_LEFT, KC_DOWN, KC_RIGHT
        )
        
        [_DRAWING] = LAYOUT_ortho_5x15(KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, KC_BSLS, KC_GRV, KC_TAB, KC_Q, KC_M, KC_E, KC_R, KC_B, KC_D, KC_NO, KC_I, KC_O, KC_P, KC_NO, KC_NO, KC_CAPS, KC_DEL, KC_BSPC, KC_A, KC_LBRC, KC_RBRC, KC_S, KC_G, KC_J, KC_H, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_ENT, KC_ENT, KC_PGUP, KC_LSFT, KC_Z, KC_Y, KC_T, KC_V, KC_U, KC_W, KC_NO, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_RSFT, KC_UP, KC_PGDN, KC_LCTL, KC_LALT, KC_X, KC_C, KC_F, KC_N, KC_SPC, KC_SPC, KC_SPC, KC_RALT, KC_RCTL, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT)

        [_FKEYSANDMEDIA] = LAYOUT_ortho_5x15(KC_GRV, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_NO, KC_NO,
        ...
        /*[2] = LAYOUT_ortho_5x15(KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, KC_GRV, KC_BSPC, KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRC, KC_RBRC, KC_INS, KC_DEL, KC_CAPS, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_ENT, KC_PAUS, KC_PGUP, KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_BSLS, KC_RSFT, KC_UP, KC_PGDN, KC_LCTL, KC_LGUI, KC_LALT, KC_F13, KC_F14, KC_SPC, KC_ENT, KC_PSCR, KC_RALT, TG(2), KC_APP, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT),
        [7] = LAYOUT_ortho_5x15(KC_TILD, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_NO, KC_NO, KC_NO, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_NO, KC_NO, KC_QUES, KC_PIPE, KC_MINS, KC_EQL, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_LBRC, KC_RBRC, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_LCBR, KC_RCBR, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO),
        [8] = LAYOUT_ortho_5x15(KC_NO, KC_ACL0, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_BTN1, KC_BTN3, KC_BTN2, KC_NO, KC_NO, KC_LSFT, KC_ACL1, KC_MS_L, KC_MS_U, KC_MS_R, KC_WH_U, KC_NO, KC_NO, KC_NO, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_INS, KC_NO, KC_LCTL, KC_ACL2, KC_NO, KC_MS_D, KC_NO, KC_WH_D, KC_NO, KC_NO, KC_NO, KC_HOME, KC_PGDN, KC_PGUP, KC_END, KC_DEL, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_PSCR, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_LGUI, KC_LALT, KC_NO, KC_NO, OSM(MOD_LCTL|MOD_LSFT), KC_NO, OSM(MOD_LSFT|MOD_LALT), KC_NO, KC_NO, KC_RALT, KC_RGUI, KC_NO, KC_NO),
        */
        
        [_SETTINGS] = LAYOUT_ortho_5x15(RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, RGB_SPI, KC_NO, KC_NO, KC_NO, KC_NO, RESET, GE_SWAP, BS_SWAP, AG_SWAP, GUI_ON, NK_ON, 
        ...
        [_SWAP] = LAYOUT_ortho_5x15(TG(_SETTINGS), TG(_DRAWING), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, 
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, 
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, 
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, 
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO)
